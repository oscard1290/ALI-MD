...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "oPthRDqJ#3rrhkGbVO_rGGhAg4UXkR2qgYObGsNczhra82CY3Sfo",
...
STICKER_NAME: process.env.STICKER_NAME || "𝐌r | TANOS 𝐋𝐑𝚸 ༼𝚇𝚈༽",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "50933340386",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "𝐌r | TANOS 𝐋𝐑𝚸 ༼𝚇𝚈༽",
// add bot owner name
...
DESCRIPTION: process.env.DESCRIPTION || "🩸𝗝𝗘 𝗦𝗨𝗜𝗦 𝗝𝗨𝗦𝗧𝗘 𝗗𝗘 𝗣𝗔𝗦𝗦𝗔𝗚𝗘🩸",
// add bot owner name    
